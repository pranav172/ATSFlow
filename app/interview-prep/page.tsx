...
import { MessageCircle, Loader2, ArrowLeft, Lightbulb, HelpCircle, ChevronDown, ChevronUp, Upload, FileText, X } from 'lucide-react';
...
export default function InterviewPrepPage() {
  ...
  const handleGenerate = async () => {
    if (resumeText.length < 50) {
      addToast({ title: 'Resume too short', description: 'Please paste or upload your resume', variant: 'danger' });
      return;
    }
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              ...
              <div 
                ...
                className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
              >
                <input
                  ref={fileInputRef}
                  type="file"
